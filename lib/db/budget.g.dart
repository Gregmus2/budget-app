...
class BudgetModel extends _BudgetModel with RealmEntity, RealmObjectBase, RealmObject {
  BudgetModel(
    ObjectId id,
    String ownerId,
    ObjectId category,
  ...
  @override
  ObjectId get category => RealmObjectBase.get<ObjectId>(this, 'category') as ObjectId;
  ...
  @override
  Stream<RealmObjectChanges<BudgetModel>> get changes => RealmObjectBase.getChanges<BudgetModel>(this);
  ...
  static SchemaObject _initSchema() {
    ...
    return const SchemaObject(ObjectType.realmObject, BudgetModel, 'BudgetModel', [
      ...
      SchemaProperty('month', RealmPropertyType.int, indexType: RealmIndexType.regular),
      SchemaProperty('year', RealmPropertyType.int, indexType: RealmIndexType.regular),
